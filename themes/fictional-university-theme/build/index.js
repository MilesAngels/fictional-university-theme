...
const search = new _modules_Search__WEBPACK_IMPORTED_MODULE_3__["default"](); //alert('just a test');
...
class Search {
  ...
  events() {
    ...
    //open overlay
    this.openButton.on("click", this.openOverlay.bind(this)); //close overlay

    this.closeButton.on("click", this.closeOverlay.bind(this)); //when user presses down either the 's' key or the 'esc' key,
  ...
  closeOverlay() {
    ...
    this.searchOverlay.removeClass("search-overlay--active"); //makes the window scroll
  ...
  getResults() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON('https://fictionaluniversity.local/wp-json/wp/v2/posts?search=' + this.searchField.val(), posts => {
